...
ggplot(all_pollutat_summary, aes(x = PM2.5, y = Ozone)) +
  ...
  labs(title = "Concentrations of Ozone vs. PM2.5", 
       x = "PM2.5 (µg/m³)", 
       y = "Ozone (ppm)",
       caption = "Correlation between observed annual average of Ozone and PM2.5 in 32 Californian counties 2021-2022") +  
  theme_minimal() +
...
ggplot(all_pollutat_summary, aes(x = PM10, y = Ozone)) +
  ...
  labs(title = "Concentrations of Ozone vs. PM10", 
       x = "PM10 (µg/m³)", 
       y = "Ozone (ppm)",
       caption = "Correlation between observed annual average of Ozone and PM10 in 32 Californian counties 2021-2022") +  
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0.5)) 
